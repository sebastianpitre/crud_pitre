...
color: #fff;
  ...
  <nav id="top" class="navbar navbar-expand-sm bg navbar-dark">
    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item">
        <a class="nav-link" onclick="location.href ='menu.php'" href="">inicio</a>
        </li>
        ...
        <ul class="dropdown-menu">
            ...
            <li><a class="dropdown-item" onclick="location.href ='crear_programa.php'" href="#">Ficha</a></li>
            <li><hr class="dropdown-divider"></li>
        ...
        <li id="sesion" class="nav-item dropdown" >
            <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-expanded="false"> <img src="img/perfil1.png" width="25px" alt=""> <?php echo $_SESSION['nusuario'] ?></a>
  ...
  <br><br>
    ...
    <input style="width: 40%;" class="btn btnglobal" type="button" onclick="location.href ='menu.php'" value="volver">
